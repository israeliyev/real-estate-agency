...
public class HouseServiceImpl implements HouseService {
    ...
    public GenericResponse<HouseDto> createHouse(HouseDto houseDto) {
        try {
            ...
            house.setCode(this.generateUniqueCode());
    ...
    private String generateUniqueCode() {
        ...
        do {
            ...
            attempt++;
        } while (houseJpaRepository.existsByCode(code) && attempt < maxAttempts);

        if (attempt >= maxAttempts) {
            throw new IllegalStateException("Failed to generate a unique 4-digit code.");
        }
